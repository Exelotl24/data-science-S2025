...
- Are there any sources of *real* uncertainty in the percent occupied
  you calculated?
  - If someone just moved or died and left a house empty just before I
    measured the data then that could be a source of real uncertainty in
    the percentage
- Are there any sources of *erroneous* uncertainty in the percent
  occupied you calculated?
  - If I did not count the homes right then that could be erroneous
    uncertainty
...
- Which sample—sequential or random—is more *representative* of all
  homes Helvig? Why?
  - Random
  - Parents or relatives may live next to each other and therefore
    sequential samples may over represent some last names
...
- Did you find any highly prevalent names using `df_sample_random` that
  ...
  - Collins and Regan are both not shown in q3 but are prevelent here.
- Is there any reason that people with the same last name might tend to
  *live near each other*?
  - Relatives sometimes buy houses next to each other or in similar
    neighborhoods for support reasons.
...
- What is highest possible prevalence for your chosen name, based on the
  ...
  - (Your response here) This question confused 1/3 Lilys so I will come
    back to this in corrections
...
- inebriation, upbringing, nutrition
...
- How are food/drugs and IQ related in the population?
...
- Pick ~20 islanders at random using the random house number generator
  used in this challenge
- Make those islanders take an IQ test
- Make them drink alcohol and retake an IQ test
- Wait for them not to be inebreated
- Make them eat bran flakes
- retake IQ test
...
- Get a wide range of houses in Arcadia
- (For experiments only: How will you ensure any effects you observe are
  due to the treatment, and not due to other factors?)
  - Ask about mood and their nutrition for that day
- I feel 20 people is enough for a sample size but also big enough to
  accomplish with our research team given IQ tests take quite a bit of
  time
