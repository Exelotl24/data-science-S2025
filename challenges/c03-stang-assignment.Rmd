...
-   Does this graph support or contradict the claim above?
    -   This graph does support the claim above, however the way the data is presented in a way that may mislead the conclusion that someone could make. As the thickness 0.081 generally has a lower elastic modulus, the lower thicknesses show no correlation with elastic modulus.
-   Is this evidence *conclusive* one way or another?
    -   The evidence is not conclusive, as mentioned above the highest thickness has the lowest values or E, there is no other correlation. It would be useful to have more data points for different thicknesses to see if there is a trend overall or not, and have a conclusive conclusion.
