...
-   Are there any sources of *real* uncertainty in the percent occupied you calculated?
    -   If someone just moved or died and left a house empty just before I measured the data then that could be a source of real uncertainty in the percentage
-   Are there any sources of *erroneous* uncertainty in the percent occupied you calculated?
    -   If I did not count the homes right then that could be erroneous uncertainty
...
-   Is this sample representative of *all* houses in Helvig? Why or why not?
    -   This sample is only representative of houses 1-25 as it is a sample and only represents a portion of the population, a larger random sample would be more representative of houses in Helvig as they will not show only houses next to each other.
...
-   Which sample---sequential or random---is more *representative* of all homes Helvig? Why?
    -   Random
    -   Parents or relatives may live next to each other and therefore sequential samples may over represent some last names
...
-   Is there any reason that people with the same last name might tend to *live near each other*?
    -   Relatives sometimes buy houses next to each other or in similar neighborhoods for support reasons.
...
-   What is highest possible prevalence for your chosen name, based on the confidence interval you constructed?
    -   (Your response here) This question confused 1/3 Lilys so I will come back to this in corrections
...
-   Pick \~20 islanders at random using the random house number generator used in this challenge
...
-   I feel 20 people is enough for a sample size but also big enough to accomplish with our research team given IQ tests take quite a bit of time
