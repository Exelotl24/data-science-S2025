...
estimation of error is less than the value of the true error as he
estimated it to be 51 and it is -151.542 - Make a quantitative
comparison between Michelson’s uncertainty and his error. - The true
error is 100.542 greater than Michelson’s uncertainty
...
- This graph shows that there is overall an upward trend between
  ...
  however I was interested to see what effect distinctness has compared
  to the velocity per day, which I did below.
...
- In the graph above, I looked at the different levels of distinctness
  versus the simulated and real velocities. It does not appear that
  distinctness has a distinct effect on velocity in the real or
  simulated velocity values. In the real measurements, lower mean
  velocity values tend to have a distinctness of 1, however higher
  velocity values do not necessarily correlate to a distinctness of 3.
