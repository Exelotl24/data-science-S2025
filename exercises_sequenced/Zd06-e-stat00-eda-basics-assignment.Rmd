...
**Observations**: - Very not true, there are more ideal diamonds than
anything else
...
**Observations**: - This is not an effective graph to analyze, it only
shows that maybe fair diamonds can be cheaper but everything else looks
even
...
**Observations**: - If anything this looks like ideal cuts are cheaper
or similar to others, other than that they still look equal.
...
**Observations**: - Fair diamonds can be up to 5 carat while others look
like they stop at 4, this would make sense with the "sacraficing cut
over carat" statement above
