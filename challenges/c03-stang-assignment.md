...
- Is there “one true value” for the material properties of Aluminum?
  - No, the elastic modulus changes slightly between the aluminum, the
    poisson’s ratio also changes slightly between the aluminum.
...
- There is a general trend between E and the thickness, however there is
  not necessarily a trend. Thicknesses under 0.08 have young’s moduli
  higher than 10250 while 0.08in thick Al has young’s moduli
  below 10250. It would be nice to see more thicknesses be tested to see
  if there is an actual trend with the data. As of right now it seems as
  though there are general “clumps” where E resides for the thickness
  but not an actual overall trend.
