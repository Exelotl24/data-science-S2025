...
- The GDPs of each continent average somewhat similarly, with the
  exception of Africa and Oceania, where African countries generally
  have lower GDPs than other continents and there are only 2 countries
  in Oceania, making it difficult to see a trend. There is also a major
  outlier in Asia with a GDP of over 90000.

**Difficulties & Approaches**:

- I wanted to view the nuance of the GDPs in each continent however the
  outlier in Asia made it difficult to view so I made a second graph
  filtering out that point. To see more differences between GDPs in
  countries, I made the plot a jitter plot rather than a scatterplot.
...
- Identify the outlier countries from q2
  - Kuwait is the major outlier in Asia, there are two outliers in the
    American: the USA and Canada, and Switzerland is an outlier in
    Europe
...
- Kuwait’s GDP significantly decreases from 1952 to 2007, while the
  other outliers increased. Asia’s GDPs overall, however, increased, as
  did Europe’s and the America’s (and Africa and Oceania).
...
- GDP generally increases over time for many continents on a log log
  scale, however there are some dips that could be attributed to changes
  in the market, trade, or economic issues. There is not a strong
  correlation, so it would be interesting to look at life expectancy
  over time to see if life expectancy actually affects GDP.
...
- Life expectancy generally increases over time, too with dips during
  some years and greater increases in others. This combination of graphs
  leads me to believe that life expectancy has something to do with
  affecting GDP per capita, it would require more research into more
  relationships between GDP and other factors, but life expectancy, from
  this data, seems to effect GDP.
