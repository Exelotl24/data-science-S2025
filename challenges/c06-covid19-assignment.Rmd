...
-   Which rows did you pick?
    -   All rows without NA values were chosen for the means and SDs and rows where population = 0
-   Why?
    -   NA values would have interefered with the calculations, and 0 population would be meaningless when calculating cases and deaths per 100k
...
-   The top cases all belong to the same county of Loving and all top deaths belong to the same county of McMullen. Both of these counties have rather small populations, with Loving having a population of 102 and McMullen having a population of 662
