...
```
    ...
    ##    <chr>         <chr>                              <dbl>                  <dbl>
    ##  1 0500000US010… Autauga County, Alaba…             55200                     NA
    ##  2 0500000US010… Baldwin County, Alaba…            208107                     NA
    ##  3 0500000US010… Barbour County, Alaba…             25782                     NA
    ##  4 0500000US010… Bibb County, Alabama               22527                     NA
    ##  5 0500000US010… Blount County, Alabama             57645                     NA
    ##  6 0500000US010… Bullock County, Alaba…             10352                     NA
    ##  7 0500000US010… Butler County, Alabama             20025                     NA
    ##  8 0500000US010… Calhoun County, Alaba…            115098                     NA
    ##  9 0500000US010… Chambers County, Alab…             33826                     NA
    ## 10 0500000US010… Cherokee County, Alab…             25853                     NA
    ## # ℹ 3,210 more rows
...
``` r
labs(
title = "Deaths per 100k Counties in VA",
    x = "Population",
...
```
    ...
    ## 
    ## $title
    ## [1] "Deaths per 100k Counties in VA"
    ## 
    ## attr(,"class")
    ## [1] "labels"
...
- It seems that generally counties with less populations have more
  deaths per 100k in Virginia, which makes sense as the percentage of
  someone dying due to covid has a greater impact on the population than
  a large city. However there is an exception where one county (guessing
  by the color and population most likely Alexandria or somewhere else
  in Northern VA) where there is a significant number of deaths.

- In the second graph, focusing on Richmond, VA, it seems that
  generally, deaths increased over time, however there was a point in
  the second half of 2021 where deaths decreased, which could indicate
  stronger mandates or restrictions (if i recall correctly fall 2021 was
  a second wave of a new strain so it would make sense that there were
  more mandates)
