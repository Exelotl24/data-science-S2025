...
**Observations**: - It turned linear :D
...
**Observations**: - Clearly shows mpg for different vehicle types, more SUVs and very few 2seaters
...
**Observations**: - It divides the classes more and shows that most SUVs are 4 wheel drive and all pickups are 4wd

**Compare `v1` and `v2`**:

-   Which visualization---`v1` or `v2`---enabled you to make more observations?
-   v2 enabled me to make more observations as it divides the classes into subclasses
-   What was the difference between `v1` and `v2`?
-   one just shows the car types while the other divides them into types of drives
...
**Observations** - Brands like audi heavily prefer one type of car like compact cars, while jeeps only make SUVs
