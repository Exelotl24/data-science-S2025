...
- Document your observations here.
  - Generally, as the size of families increase, so does median
    household income, however it tends to be heavily dependent on where
    they live.
  - Overall, 2-person families tend to have the lowest income out of all
    of the groups
  - 5 person families in Dukes and Nantucket as well as 6 person
    families in Hampshire and Berkshire have a very wide range of
    income, wider than other families in the areas.
- Can you confidently distinguish between household incomes in Suffolk
  county? Why or why not?
  - I can distinguish between household incomes in Suffolk but not
    confidently. the bars overlap with each other slightly and the green
    and blue hues are too similar to distinguish from.
- Which counties have the widest confidence intervals?
  - Nantucket, Dukes, and Berkshire have the most wide confidence
    intervals
...
- There seems to be a slight correlation between income and population,
  but not as much as I expected. The reason I chose Virginia is because
  some of the richest counties in the country are close to DC, so I
  wanted to see if population was a factor, but that does not seem to be
  the case.
