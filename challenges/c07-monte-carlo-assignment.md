...
```
    ...
    ## # A tibble: 1 × 5
    ##      sd pi_est     se pi_lo pi_hi
    ##   <dbl>  <dbl>  <dbl> <dbl> <dbl>
    ## 1  1.63   3.15 0.0231  3.11  3.20
...
- Comment on the width of your CI(s). Would your estimate of $\pi$ be
  ...
  - Not good enough as a precise estimate, for something like sending a
    rocket into orbit, you need to be much more exact than the estimate
- What would be a *valid* way to make your CI more narrow?
  - Increasing the confidence that you need to something near 99% or
    higher for more precise estimates.
