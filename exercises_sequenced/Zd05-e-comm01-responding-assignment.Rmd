...
-   Is the bolded response **active** or **passive**? Why?
    -   Active, they directly address the question and explain
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Constructive, they directly acknowlege the question and answer it with positive connotation
...
-   Is the bolded response **active** or **passive**? Why?
    -   Active, they directly address the question
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Destructive, they quickly answer the quesiton, making the questioner feel dumb and move on
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive, they do not address any part of the presentation
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Destructive, it kind of comes off agro and like they just care about their one point.
